	...
	<section class="wrapper scrollable">
		...
		<div class="main-grid">
			<div class="agile-grids">	
                ...
                <?php  $cv=$con->query("select * from master_product");
										while($r1=$cv->fetch_array())
									{
											$temp=explode('/',$r1['p_images']);
                        ...
                        <img src="<?php print "../img/".$image;?>" height="200px" width="200px">
                         ...
                         <div class="grids-heading gallery-heading">
									<h2 style="color:#4148C5; font-family:Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif;"><?php echo $r1['p_name']." Images:";?></h2>
                                    <a class="btn btn-dark fa fa-edit" href="edit_product_gallery.php?edit_gallery=<?php echo $r1['p_id'];?>">UPDATE</a>
						</div>
                        <?php }?>
						<script>
